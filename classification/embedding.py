...
TB_SUMMARY_DIR="tmp/intrusion_detection"
GLOABAL_STEP=2000
...
with tf.name_scope("hidden_layer3") as scope:
    W3 = tf.Variable(tf.random_normal([32, nb_classes]), name='weight3')
...
writer =tf.summary.FileWriter(TB_SUMMARY_DIR+"DNN__0.01_H3")
...
embedding_config.sprite.single_image_dim_
