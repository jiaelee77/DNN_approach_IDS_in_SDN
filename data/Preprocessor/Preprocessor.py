...
#test=pd.concat([scaled_test, test_oh_protocol], axis=1)
#test.to_csv('processed_data/test.csv')

#prediction=pd.concat([scaled_prediction, prediction_oh_protocol], axis=1)
#prediction.to_csv('processed_data/prediction.csv')
...
#test_oh_attack_type.to_csv('processed_data/oh_test_attack.csv')
#prediction_oh_attack_type.to_csv('processed_data/oh_prediction_attack.csv')
